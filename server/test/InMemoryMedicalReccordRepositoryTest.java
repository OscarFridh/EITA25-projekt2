...
class InMemoryMedicalReccordRepositoryTest {
    ...
    void fetchAddedMedicalReccord() {
        ...
        // When
        int firstId = sut.create(new Doctor(1, "Division"), new Patient(1), "Medical reccord 1");
        int secondId = sut.create(new Doctor(1, "Division"), new Patient(1), "Medical reccord 2");
    ...
    void testDelete() {
        ...
        // When
        int id = sut.create(new Doctor(1, "Division"), new Patient(1), "Medical reccord 1");
